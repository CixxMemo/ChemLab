...
Durum işaretleri: `(x)` doğrulanarak tamamlandı; `( )` kabul koşulları henüz bütünüyle karşılanmadı. Bu işaretler plan kapsamını değiştirmez.

### (x) Faz 0 — İçerik ve kimya güvenlik sınırı
...
### (x) Faz 1 — Ana sayfa, yönlendirme ve iki mod

**Kontrol notu:** Ana sayfa, iki mod, konu/deney adresleri ve 60/40 simülasyon düzeni mevcut. Laboratuvar, büyük ekran penceresi ve öğrenci tahmin ekranındaki görünür etkileşimli hedefler masaüstü ve mobil tarayıcıda ölçüldü; 40×40 px altında hedef kalmadı.
...
### (x) Faz 2 — Ortak ders içeriği ve ilk uçtan uca öğrenme döngüsü
...
### (x) Faz 3 — Rehberli görevler ve öğrenci ilerlemesi
